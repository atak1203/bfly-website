...
window.BFLY_TRANSLATIONS = {
  en: {
    ...
    vcard1_body:          'Our first aircraft project.',
    vcard2_title:         'TurcoFighter',
    vcard2_body:          'Our second aircraft project.',
    vcard3_title:         'X',
    vcard3_body:          'Our latest aircraft project.',
  ...
  tr: {
    ...
    vehicle_title:        'Gelişmiş Mühendislik',
    vcard1_title:         'SkyWipe',
    vcard1_body:          'İlk hava aracı projemiz.',
    vcard2_title:         'TurcoFighter',
    vcard2_body:          'İkinci hava aracı projemiz.',
    vcard3_title:         'X',
    vcard3_body:          'En güncel hava aracı projemiz.',
